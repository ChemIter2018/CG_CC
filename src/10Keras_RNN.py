...
pickle.dump(ScalerSave, open('models/Keras_RNN_ScalerSave.pkl', 'wb'))
...
# Save Model
model.save('models/Keras_RNN')
# model = tf.keras.models.load_model('models/Keras_RNN')
...
plt.savefig('figures/10TF_RNN_PE.png', dpi=1000)
