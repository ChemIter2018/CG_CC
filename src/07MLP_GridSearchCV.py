...
pickle.dump(ScalerSave, open('models/SL_MLP_ScalerSave.pkl', 'wb'))
...
f = open("models/SL_MLP_best_params.txt", "wb")
...
joblib.dump(mlp_reg, 'models/scikit-learn_MLP.model')
# mlp_reg = joblib.load('models/scikit-learn_MLP.model')
...
plt.savefig('figures/07SL_MLP_PE.png', dpi=1000)
