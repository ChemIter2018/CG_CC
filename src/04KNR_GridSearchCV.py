...
pickle.dump(ScalerSave, open('models/SL_KNR_ScalerSave.pkl', 'wb'))
...
f = open("models/SL_KNR_best_params.txt", "wb")
...
joblib.dump(knr_reg, 'models/scikit-learn_KNR.model')
# knr_reg = joblib.load('models/scikit-learn_KNR.model')
...
plt.savefig('figures/04SL_KNR_PE.png', dpi=1000)
