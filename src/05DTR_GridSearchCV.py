...
pickle.dump(ScalerSave, open('models/SL_DTR_ScalerSave.pkl', 'wb'))
...
f = open("models/SL_DTR_best_params.txt", "wb")
...
joblib.dump(dtr_reg, 'models/scikit-learn_DTR.model')
# dtr_reg = joblib.load('models/scikit-learn_DTR.model')
...
plt.savefig('figures/05SL_DTR_PE.png', dpi=1000)
