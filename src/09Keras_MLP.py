...
pickle.dump(ScalerSave, open('models/Keras_MLP_ScalerSave.pkl', 'wb'))
...
# Save or Load Model
model.save('models/Keras_MLP')
# model = tf.keras.models.load_model('models/Keras_MLP')
...
plt.savefig('figures/09TF_MLP_PE.png', dpi=1000)
